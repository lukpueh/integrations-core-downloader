...
class TUFDownloader:
    ...
    def __init__(self, path_to_tuf_config_file):
        '''
        This object must be given a configuration file, an example of which
        ...
        # configuration file. Alternatively, you may also toggle this behaviour
        # using an environment variable (TUF_ENABLE_LOGGING).
    ...
    def download(self, target_relpath, dest_dir):
        target_path = self._get_target(target_relpath)
        shutil.copy(target_path, dest_dir)
